...
public class ExtendedAllureTestNg implements
        ISuiteListener,
        ITestListener,
        IInvokedMethodListener,
        IConfigurationListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(ExtendedAllureTestNg.class);
    ...
    public ExtendedAllureTestNg(final AllureLifecycle lifecycle) {
        this.lifecycle = lifecycle;
    }

    public ExtendedAllureTestNg() {
        this.lifecycle = ExtendedAllureLifecycle.getLifecycle();
    }
